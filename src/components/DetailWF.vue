   ...
   <div class="amazing-MN">
    <div class="container">
      <div class="row">
          ...
          <div class="item-MN">
              <div class="col-lg-12">
                <div class="image"><img src="../../public/assets/images/wf05.jpg" alt="img01"></div>
              </div>
              <div class="col-lg-12 align-self-center">
                <div class="content">
                  <h4>{{ $t("Water_Festival_Title") }}</h4>
                  <p>{{ $t("Water_Detail") }}</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/wf04.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/wf02.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/wf03.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/wf01.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
