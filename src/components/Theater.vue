   ...
   <div class="amazing-MN">
    <div class="container">
      <div class="row">
          ...
          <div class="item-MN">
              <div class="col-lg-12">
                <div class="image"><img src="assets/images/art2.jpg" alt="img01"></div>
              </div>
              <div class="col-lg-12 align-self-center">
                <div class="content">
                  <h4>{{ $t("Theater_Title") }}</h4>
                  <p>{{ $t("Detail_Th")}}</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/Theater01.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/Theater02.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/Theater03.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="main-button">
              <router-link to="/arts" class="nav-link">{{ $t("Return") }}</router-link>
          </div>
        </div>
      </div>
    </div>
